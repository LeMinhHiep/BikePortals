...
namespace MVCData.Helpers.SqlProgrammability.StockTasks
{
    public class Inventories
    {
        ...
        private void WarehouseJournal()
        {
            ...
            queryString = queryString + "                   " + this.WarehouseJournalBuildSQLA(false, false) + "\r\n";
            queryString = queryString + "       ELSE    IF  (@isFullJournal = 1 AND @IsAmountIncluded = 0) " + "\r\n";
            queryString = queryString + "                   " + this.WarehouseJournalBuildSQLA(true, false) + "\r\n";
            queryString = queryString + "       ELSE    IF  (@isFullJournal = 0 AND @IsAmountIncluded = 1) " + "\r\n";
            queryString = queryString + "                   " + this.WarehouseJournalBuildSQLA(false, true) + "\r\n";
            queryString = queryString + "       ELSE        " + "\r\n"; //(@isFullJournal = 1 AND @IsAmountIncluded = 1) 
            queryString = queryString + "                   " + this.WarehouseJournalBuildSQLA(true, true) + "\r\n";
        ...
        private string WarehouseJournalBuildSQLA(bool isFullJournal, bool isAmountIncluded)
        {
            string queryString = "";
            ...
            queryString = queryString + "                       FROM       (" + "\r\n";
            queryString = queryString + "                       " + this.WarehouseJournalBuildSQLB(isFullJournal, isAmountIncluded) + "\r\n";
            queryString = queryString + "                           )WarehouseJournalUnion" + "\r\n";
            ...
            queryString = queryString + "       WHERE       Commodities.CommodityTypeID IN (" + (int)GlobalEnums.CommodityTypeID.Parts + ", " + (int)GlobalEnums.CommodityTypeID.Consumables + ") " + "\r\n";
        ...
        private string WarehouseJournalBuildSQLB(bool isFullJournal, bool isAmountIncluded)
        {
            string queryString = "";
            ...
            queryString = queryString + "                           FROM        WarehouseBalanceDetail " + "\r\n";
            queryString = queryString + "                           WHERE      (EntryDate = @EntryDate " + (isAmountIncluded ? " OR EntryDate = dbo.EOMONTHTIME(@ToDate, 9999)" : "") + ") AND " + this.WarehouseJournalWarehouseFilter("WarehouseBalanceDetail") + " AND " + this.WarehouseJournalCommodityFilter("WarehouseBalanceDetail") + "\r\n";
            ...
            if (isFullJournal)
            {
                ...
                queryString = queryString + "                       FROM        StockTransfers INNER JOIN " + "\r\n";
                queryString = queryString + "                                   StockTransferDetails ON StockTransfers.EntryDate < @FromDate AND ROUND(StockTransferDetails.Quantity - StockTransferDetails.QuantityReceipt, " + (int)GlobalEnums.rndAmount + ") > 0 AND " + this.WarehouseJournalWarehouseFilter("StockTransfers") + " AND " + this.WarehouseJournalCommodityFilter("StockTransferDetails") + " AND StockTransfers.StockTransferID = StockTransferDetails.StockTransferID " + "\r\n";
                if (isAmountIncluded)
                ...
                queryString = queryString + "                       FROM        StockTransfers INNER JOIN " + "\r\n";
                queryString = queryString + "                                   GoodsReceiptDetails ON StockTransfers.EntryDate < @FromDate AND GoodsReceiptDetails.EntryDate >= @FromDate AND " + this.WarehouseJournalWarehouseFilter("StockTransfers") + " AND " + this.WarehouseJournalCommodityFilter("GoodsReceiptDetails") + " AND GoodsReceiptDetails.GoodsReceiptTypeID = " + (int)GlobalEnums.GoodsReceiptTypeID.StockTransfer + " AND StockTransfers.StockTransferID = GoodsReceiptDetails.VoucherID " + "\r\n";
                if (isAmountIncluded)
            ...
            queryString = queryString + "                           FROM        GoodsReceiptDetails " + "\r\n";
            queryString = queryString + "                           WHERE       GoodsReceiptDetails.EntryDate > @EntryDate AND GoodsReceiptDetails.EntryDate <= @ToDate AND " + this.WarehouseJournalWarehouseFilter("GoodsReceiptDetails") + " AND " + this.WarehouseJournalCommodityFilter("GoodsReceiptDetails") + "\r\n";
            ...
            queryString = queryString + "                           WHERE       SalesInvoiceDetails.EntryDate > @EntryDate AND SalesInvoiceDetails.EntryDate <= @ToDate AND " + this.WarehouseJournalWarehouseFilter("SalesInvoiceDetails") + " AND " + this.WarehouseJournalCommodityFilter("SalesInvoiceDetails") + "\r\n";
            ...
            queryString = queryString + "                           FROM        StockTransferDetails " + "\r\n";
            queryString = queryString + "                           WHERE       EntryDate > @EntryDate AND EntryDate <= @ToDate AND " + this.WarehouseJournalWarehouseFilter() + " AND " + this.WarehouseJournalCommodityFilter() + "\r\n";
        ...
        private string WarehouseJournalWarehouseFilter()
        { return this.WarehouseJournalWarehouseFilter(""); }

        private string WarehouseJournalWarehouseFilter(string tableName)
        {
            return (tableName != "" ? tableName + "." : "") + "WarehouseID IN (SELECT WarehouseID FROM @WarehouseFilter) " + "\r\n";
        }

        private string WarehouseJournalCommodityFilter()
        { return this.WarehouseJournalCommodityFilter(""); }

        private string WarehouseJournalCommodityFilter(string tableName)
        {
            return " (@CommodityIDList = '' OR " + (tableName != "" ? tableName + "." : "") + "CommodityID IN (SELECT CommodityID FROM @CommodityFilter)) " + "\r\n";
        }
        ...
        private void VehicleCard()
        {
            ...
            queryString = queryString + "                               Customers Suppliers ON PurchaseOrderDetails.CommodityTypeID = " + (int)GlobalEnums.CommodityTypeID.Vehicles + " AND PurchaseOrderDetails.LocationID = @LocationID AND PurchaseOrderDetails.EntryDate <= @ToDate AND PurchaseOrderDetails.Quantity > PurchaseOrderDetails.QuantityInvoice AND PurchaseOrderDetails.SupplierID = Suppliers.CustomerID " + "\r\n";
            ...
            queryString = queryString + "                               Customers Suppliers ON PurchaseInvoiceDetails.CommodityTypeID = " + (int)GlobalEnums.CommodityTypeID.Vehicles + " AND PurchaseInvoiceDetails.LocationID = @LocationID AND PurchaseInvoiceDetails.EntryDate <= @ToDate AND PurchaseInvoiceDetails.Quantity > PurchaseInvoiceDetails.QuantityReceipt AND PurchaseInvoiceDetails.SupplierID = Suppliers.CustomerID " + "\r\n";
