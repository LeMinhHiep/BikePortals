...
namespace MVCClient.App_Start
{
    public static class AutoMapperConfig
    {
        public static void SetupMappings()
        {
            ...
            Mapper.CreateMap<TransferOrder, TransferOrderViewModel>();
            Mapper.CreateMap<TransferOrderViewModel, TransferOrder>();
            Mapper.CreateMap<TransferOrder, TransferOrderDTO>();
            Mapper.CreateMap<TransferOrderPrimitiveDTO, TransferOrder>();
            Mapper.CreateMap<TransferOrderViewDetail, TransferOrderDetailDTO>();
            Mapper.CreateMap<TransferOrderDetailDTO, TransferOrderDetail>();
