...
namespace MVCModel.Models
{
    ...
    public partial class TotalBikePortalsEntities : DbContext
    {
        ...
        public virtual ObjectResult<WarehouseJournal> WarehouseJournal(Nullable<System.DateTime> fromDate, Nullable<System.DateTime> toDate, string warehouseIDList, string commodityIDList, Nullable<bool> isFullJournal)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<WarehouseJournal>("WarehouseJournal", fromDateParameter, toDateParameter, warehouseIDListParameter, commodityIDListParameter, isFullJournalParameter);
        }
